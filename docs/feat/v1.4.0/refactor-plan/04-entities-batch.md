...
- [x] commit 3: useCreate/UpdateReaderPerspective mutation（含 handleQuickReveal 全量回传，§6）+ saving 由 mutation.isPending 推导 + 删 bumpRefresh/useRefresh/useApp + refreshNonce effect + refresh 按钮改 invalidateQueries（对齐 timeline/storyarc）
